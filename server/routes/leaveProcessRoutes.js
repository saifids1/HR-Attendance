...
router.get("/my-leave-types", auth, leaveProcessController.getMyLeaveTypes);

router.put("/request/:id/edit", auth, leaveProcessController.editLeave);

// Get leave balance/quota of logged-in employee
router.get("/my-balance", auth, leaveProcessController.getMyLeaveBalance);

// Get leave dashboard of logged-in employee
router.get("/dashboard", auth, leaveProcessController.getLeaveDashboard);

// Apply for leave
router.post("/apply", auth, leaveProcessController.applyLeave);

// Get logged-in employee's leave requests
router.get("/my-requests", auth, leaveProcessController.getMyLeaveRequests);

router.get(
  "/reporting-leave-status-counts/:id",
  auth,
  leaveProcessController.getReportingLeaveStatusCounts,
);
...
router.post("/request/:id/cancel", auth, leaveProcessController.cancelLeave);
...
router.post("/request/:id/approve", auth, leaveProcessController.approveLeave);

// Reject leave request
router.post("/request/:id/reject", auth, leaveProcessController.rejectLeave);
...
router.get("/all-requests", auth, leaveProcessController.getAllLeaveRequests);
