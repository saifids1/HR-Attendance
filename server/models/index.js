...
db.Personal.hasMany(db.Organizations, {
  foreignKey: "pr_id",
  as: "organizations",
});

db.Organizations.belongsTo(db.Personal, {
  foreignKey: "pr_id",
  as: "personal",
});

// Personal <-> LeaveRequests

db.Personal.hasMany(db.LeaveRequests, {
  foreignKey: "lr_pr_id",
  as: "leaveRequests",
});

db.LeaveRequests.belongsTo(db.Personal, {
  foreignKey: "lr_pr_id",
  as: "personal",
});
...
db.Personal.hasMany(db.LeaveQuota, {
  foreignKey: "lq_pr_id",
  as: "leaveQuotas",
});

db.LeaveQuota.belongsTo(db.Personal, {
  foreignKey: "lq_pr_id",
  as: "personal",
});
...
db.Personal.hasMany(db.UserRoleRelation, {
  foreignKey: "pr_id",
  as: "userRoles",
});

db.UserRoleRelation.belongsTo(db.Personal, {
  foreignKey: "pr_id",
  as: "personal",
});
...
db.UsrRoleMaster.hasMany(db.UserRoleRelation, {
  foreignKey: "rl_role_id",
  as: "userRoles",
});

db.UserRoleRelation.belongsTo(db.UsrRoleMaster, {
  foreignKey: "rl_role_id",
  as: "role",
});
...
db.LeaveTypes.hasMany(db.LeaveRequests, {
  foreignKey: "lr_leave_type_id",
  as: "requests",
});

db.LeaveRequests.belongsTo(db.LeaveTypes, {
  foreignKey: "lr_leave_type_id",
  as: "leaveType",
});
...
db.LeaveStatus.hasMany(db.LeaveRequests, {
  foreignKey: "lr_status_id",
  as: "requests",
});

db.LeaveRequests.belongsTo(db.LeaveStatus, {
  foreignKey: "lr_status_id",
  as: "status",
});
...
db.LeaveTypes.hasMany(db.LeaveQuota, {
  foreignKey: "lq_leave_type_id",
  as: "quotas",
});

db.LeaveQuota.belongsTo(db.LeaveTypes, {
  foreignKey: "lq_leave_type_id",
  as: "leaveType",
});
...
db.EmployeeTypeMaster.hasMany(db.LeaveQuota, {
  foreignKey: "lq_emptype",
  as: "quotas",
});

db.LeaveQuota.belongsTo(db.EmployeeTypeMaster, {
  foreignKey: "lq_emptype",
  as: "employeeType",
});
...
db.EmployeeTypeMaster.hasMany(db.LeaveTypes, {
  foreignKey: "lt_emptype",
  as: "leaveTypes",
});

db.LeaveTypes.belongsTo(db.EmployeeTypeMaster, {
  foreignKey: "lt_emptype",
  as: "employeeType",
});
...
db.CompaniesMaster.hasMany(db.Organizations, {
  foreignKey: "or_company_id",
  as: "employees",
});

db.Organizations.belongsTo(db.CompaniesMaster, {
  foreignKey: "or_company_id",
  as: "company",
});
...
db.EmployeeTypeMaster.hasMany(db.Organizations, {
  foreignKey: "or_employee_type_id",
  as: "employees",
});

db.Organizations.belongsTo(db.EmployeeTypeMaster, {
  foreignKey: "or_employee_type_id",
  as: "employeeType",
});
...
db.Organizations.belongsTo(db.Organizations, {
  foreignKey: "or_reporting_to_id",
  as: "reportingTo",
});

db.Organizations.hasMany(db.Organizations, {
  foreignKey: "or_reporting_to_id",
  as: "reportees",
});
...
// LeaveRequests <-> ReportingTo

db.Personal.hasMany(db.LeaveRequests, {
  foreignKey: "lr_reporting_to",
  as: "reportedRequests",
});
...
db.Personal.hasOne(db.Login, {
  foreignKey: "pr_id",
  as: "login",
});

db.Login.belongsTo(db.Personal, {
  foreignKey: "pr_id",
  as: "personal",
});
...
db.Personal.hasMany(db.UserImage, {
  foreignKey: "pr_id",
  as: "userImages",
});

db.UserImage.belongsTo(db.Personal, {
  foreignKey: "pr_id",
  as: "personal",
});
...
db.Personal.hasMany(db.Address, {
  foreignKey: "pr_id",
  as: "addresses",
});

db.Address.belongsTo(db.Personal, {
  foreignKey: "pr_id",
  as: "personal",
});

db.Personal.hasMany(db.BankAccount, {
  foreignKey: "pr_id",
  as: "bankAccounts",
});

db.BankAccount.belongsTo(db.Personal, {
  foreignKey: "pr_id",
  as: "personal",
});

db.Personal.hasMany(db.Contact, {
  foreignKey: "pr_id",
  as: "contacts",
});

db.Contact.belongsTo(db.Personal, {
  foreignKey: "pr_id",
  as: "personal",
});

db.Personal.hasMany(db.Document, {
  foreignKey: "pr_id",
  as: "documents",
});

db.Document.belongsTo(db.Personal, {
  foreignKey: "pr_id",
  as: "personal",
});
...
db.Personal.hasMany(db.Nominee, {
  foreignKey: "pr_id",
  as: "nominees",
});

db.Nominee.belongsTo(db.Personal, {
  foreignKey: "pr_id",
  as: "personal",
});
...
db.Organizations.belongsTo(db.VendorMaster, {
  foreignKey: "or_vendor_id",
  as: "vendor",
});

db.Organizations.belongsTo(db.DepartmentMaster, {
  foreignKey: "or_department_id",
  as: "department",
});

db.Organizations.belongsTo(db.DesignationMaster, {
  foreignKey: "or_designation_id",
  as: "designation",
});
...
db.HrSupportRequest = require("./hrSupportRequest")(
  sequelize,
  DataTypes
);
