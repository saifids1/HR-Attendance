...
//    const isAdminWithEmp = location.pathname.startsWith("/admin/employee-details");
...
const Overview = () => {
  ...
  if (loading)
    ...
    // console.log("isEmployeeDashboard",isEmployeeDashboard)

  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-3 sm:px-3">

      {/* HEADER */}
      <div className={`sticky z-20 top-2 bg-[#222F7D] rounded-xl py-3 mb-6 shadow-lg flex justify-center items-center px-6 h-[40px] ${location.pathname === "/employee" ? "mt-1" : "-mt-[5px]"
          }`}>
