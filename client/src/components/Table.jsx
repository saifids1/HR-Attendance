...
//     // console.log("dayStr, isToday, isHoliday, index",dayStr, isToday, isHoliday, index)
//     // if (isHoliday) return "bg-blue-50 text-blue-900 font-medium";
//     // if (dayStr === "Sunday" && isAdmin && isAdminWithEmp) return "bg-[#faa307] text-white font-semibold";
//     // if (dayStr === "Saturday" && isAdmin && isAdminWithEmp) return "bg-[#D1FFBD] text-dark font-semibold";
//     // if (isToday) return "bg-white font-semibold";
//     // return index % 2 === 0 ? "bg-white" : "bg-gray-50";

//      if (isHoliday) return "bg-blue-50 text-blue-900 font-medium";
//     if (dayStr === "Sunday" ) return "bg-[#faa307] text-white font-semibold";
//     if (dayStr === "Saturday") return "bg-[#D1FFBD] text-dark font-semibold";
//     if (isToday) return "bg-white font-semibold";
//     return index % 2 === 0 ? "bg-white" : "bg-gray-50";
//   };
...
//   console.log("isAdminWithEmp",isAdminWithEmp);

//   // Logic to switch data source
//   // const data = isAdmin && !isAdminWithEmp ? adminAttendance : employeeAttendance;
...
//   // const headers = isAdmin && !isAdminWithEmp
...
//             //   (row) =>
//             //     row.emp_id &&
//             //     (isAdmin && !isAdminWithEmp  ? row.is_active === true : true) &&
//             //     row.emp_id !== "2020"
//             // )
//             .map((row, i) => {
...
//               // console.log("dayStr",typeof dayStr,dayStr);
//               // console.log(dayStr[0].toUpperCase() + dayStr.substring(1));
...
//                         {dayStr[0].toUpperCase() + dayStr.substring(1)}
//                       </td>
...
//   const getRowClass = (dayStr, isToday, isHoliday, index) => {
//   const isAdminViewingEmployee = isAdmin && isEmployAttendance && !isEmployee;

//   if (isHoliday) return "bg-blue-50 text-blue-900 font-medium";

//   if (isAdminViewingEmployee && dayStr === "Sunday")
//     return "bg-[#faa307] text-white font-semibold";

//   if (isAdminViewingEmployee && dayStr === "Saturday")
//     return "bg-[#D1FFBD] text-dark font-semibold";
